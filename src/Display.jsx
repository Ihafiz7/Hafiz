    ...
    <div className='w-full min-h-full mt-8 flex flex-col items-center justify-center bg-gradient-display px-4'>
        ...
        <div className='flex flex-col items-center justify-center mt-8' id="Contact">
            ...
            <div className='flex flex-col items-center justify-center text-white mb-8'>
                ...
                <p className=' flex items-center justify-center font-monsa'>Made With<img src='react.svg' alt='React Logo' className='w-12 h-12 ml-4'/><span className='font-bold sm:text-lg md:text-4xl '>React</span> <span className='mx-4'> and</span> <img src='tailwind.svg' alt='Tailwind Logo' className='w-12 h-12'/><span className='font-bold sm:text-lg md:text-3xl'>Tailwind</span></p>
            </div>
        </div>
    </div>
  )
